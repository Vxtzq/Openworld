...
class InfiniteTerrain(Entity):
    def __init__(self, **kwargs):
        ...
        self.chunks = {}
        self.chunk_size = 16
        self.chunk_distance = 7
        self.terrain_scale = 200  # Controls the size of the terrain features
        self.height_scale = 20    # Controls the height of the terrain features
        self.octaves = 4          # Number of layers of Perlin noise to use
    ...
    def generate_chunk(self, x, z):
        ...
        for i in range(chunk_size_plus_one):
            for j in range(chunk_size_plus_one):
                ...
                height = pnoise2(world_x / self.terrain_scale, world_z / self.terrain_scale, 
